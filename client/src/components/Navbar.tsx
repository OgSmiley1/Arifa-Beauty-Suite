      ...
      {isOpen && (
        <div className="md:hidden bg-background border-b border-border animate-in slide-in-from-top-2">
          <div className="px-4 py-6 space-y-6">
            ...
            <div className="pt-6 border-t border-border flex flex-col space-y-4 text-center">
              <Link href="/profile">
                <span className="text-xs tracking-widest uppercase text-foreground/80 hover:text-foreground cursor-pointer" onClick={() => setIsOpen(false)}>
                  My Account
                </span>
              </Link>
              <Link href="/admin">
                <span className="text-xs tracking-widest uppercase text-foreground/40 hover:text-foreground cursor-pointer" onClick={() => setIsOpen(false)}>
                  Admin Login
                </span>
              </Link>
            </div>
